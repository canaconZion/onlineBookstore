...
<script>
	...
	function cartMoney(total){
		totalCount = parseInt(total);
		//如果数量为0，判断是否要删除商品
		if (totalCount == 0) {
			var flag = window.confirm("未选择任何书籍，请返回书籍列表选择书籍");
			if(flag){
				location.href = "${pageContext.request.contextPath}/showProductByPage"
			}
			else{
			...
			location.href = "${pageContext.request.contextPath}/client/order.jsp"
		}
	}
			...
			<tr>
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td>
								<img src="${pageContext.request.contextPath}/client/ad/page_ad.png" width="900" height="89" />
								<table width="100%" border="0" cellspacing="0">
									<tr>
										<td>
									...
									<tr>
										<td>
											...
											<div style="text-align:right; margin-top:10px">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
                                                 <!--结账 -->
												<a href="#" onclick="cartMoney(${total})">
