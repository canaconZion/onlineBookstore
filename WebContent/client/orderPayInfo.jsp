									...
									<tr>
										<td>
											...
											<p style="text-align:right">
												...
												<a href="${pageContext.request.contextPath}/client/createOrderSuccess.jsp">
													<img src="${pageContext.request.contextPath }/client/images/gif53_030(1).png" width="204" height="51" border="0" /> 
												</a>
											</p>
											</c:if>
										</td>
