			...
			<tr>
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td><img src="${pageContext.request.contextPath }/client/ad/page_ad.png" width="900" height="84" />
								<table width="100%%" border="0" cellspacing="0">
									<tr>
										<td width="30%">
										...
										<td style="padding:20px 5px 5px 5px">
											...
											<hr /> 类别：${p.category }
											<hr /> 上传者：<a href="${pageContext.request.contextPath}/userInformation?user=${p.user}"> ${p.user}</a>
											<hr />
											<p>
												<b>内容简介：</b>
											</p> ${p.description}
