...
<body  bgcolor="#333">
	<p:user/>
	<form action="${pageContext.request.contextPath}/pay" method="post" style="color:white">
	<h1>欢迎使用共享书城支付系统</h1>
	<br/>
	请确认您的订单后再进行支付<br/>
	<br/>
		订单号：<INPUT TYPE="text" NAME="orderid" value="${param.id} " readonly>
		支付金额：<INPUT TYPE="text" NAME="money" value="${param.money}" readonly>元
		<br/>
		<br/>
		<div class="divBank">
			<div class="divText" style="color:white">选择网上银行</div><br/>
			<div style="margin-left: 20px;">
				<div style="margin-bottom: 20px;">
				<input id="ICBC-NET-B2C" type="radio" name="yh"
						value="AcountBalance" checked="checked" />使用账户余额<br/><br/>
					<input id="ICBC-NET-B2C" type="radio" name="yh"
						value="ICBC-NET-B2C" /> 
