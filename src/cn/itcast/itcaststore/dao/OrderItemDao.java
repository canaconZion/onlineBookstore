...
public class OrderItemDao {
	...
	//
	public List<String> findBookById(String id) throws SQLException {
		String sql="select product_id from orderItem where order_id=?";
		QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
		return runner.query(sql, new BeanListHandler<String>(String.class),id);
	}
