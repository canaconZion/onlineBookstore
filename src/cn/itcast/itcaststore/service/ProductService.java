...
public class ProductService {
	...
	public List<Product> findProductByUser(String user){
		try {
			 return dao.findProductByUser(user);
		}catch(SQLException e) {
	...
	public Product searchBookByName(String searchfield) throws FindProductByIdException {
		try {
			return dao.searchBookByName(searchfield);
		} catch (SQLException e) {
			e.printStackTrace();
			throw new FindProductByIdException("根据名称查找商品失败");
		}
	}
}
